      ...
      typography: () => ({
        DEFAULT: {
          css: {
            ...
            '--tw-prose-links': '#B87348',
            '--tw-prose-bold': '#EFE9DC',
            '--tw-prose-counters': '#B87348',
            '--tw-prose-bullets': '#B87348',
            '--tw-prose-hr': 'rgba(184,115,72,0.3)',
            '--tw-prose-quotes': '#9C9486',
            '--tw-prose-quote-borders': '#B87348',
            '--tw-prose-captions': '#9C9486',
            '--tw-prose-code': '#EFE9DC',
            '--tw-prose-pre-code': '#EFE9DC',
            '--tw-prose-pre-bg': '#17181B',
            '--tw-prose-th-borders': 'rgba(184,115,72,0.3)',
            '--tw-prose-td-borders': 'rgba(184,115,72,0.2)',
            'h1, h2, h3, h4': { fontFamily: 'var(--font-display)', fontWeight: '400' },
            a: { textDecorationColor: 'rgba(184,115,72,0.4)' },
            'a:hover': { textDecorationColor: '#B87348' },
